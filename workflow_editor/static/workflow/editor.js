...
export function createWorkflowEditor(elements, markChanged) {
  ...
  function createNodeUI(node) {
    ...
    const symbols = { input: 'IN', output: 'OUT', router: 'R', construct_message: 'M', construct_content: 'C', construct_list: 'L', foreach: 'FE', history: 'H', local_tool: 'LT', remote_sync_tool: 'RS', remote_async_tool: 'RA', workflow: 'WF' };
    element.type = 'button';
