...
export function createWorkflowEditor(elements, markChanged) {
  ...
  function createNodeUI(node) {
    ...
    const symbols = { input: 'IN', output: 'OUT', router: 'R', construct_message: 'M', construct_content: 'C', split_event: 'E/', construct_list: 'L', list_append: 'L+', foreach: 'FE', history: 'H', local_tool: 'LT', remote_sync_tool: 'RS', remote_async_tool: 'RA', context_create: 'C+', context_read: 'CR', context_write: 'CW', workflow: 'WF' };
    element.type = 'button';
